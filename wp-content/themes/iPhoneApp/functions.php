...
//** FRONT-END FILES **//
	...
	function autoinstall_admin_header()
	{
		...
		if(strstr($_SERVER['REQUEST_URI'],'themes.php') && $_REQUEST['template']=='' && $_GET['page']=='') 
		{
			...
			{
				delete_dummy_data();	
				$dummy_deleted = __('<p><b>All Dummy data has been removed from your database successfully!</b></p>');
			}
			...
			{
				$theme_actived_success = __('<p class="message">Theme activated successfully.</p>');	
			}
			...
			if($post_counts>0)
			{
				$dummy_data_msg = __('<p> <b>Sample data has been populated on your site. Wish to delete sample data?</b> <br />  <a class="button_delete" href="'.get_option('siteurl').'/wp-admin/themes.php?dummy=del">Yes Delete Please!</a><p>');
			}else
			{
				$dummy_data_msg = __('<p> <b>Would you like to auto install this theme and populate sample data on your site?</b> <br />  <a class="button_insert" href="'.get_option('siteurl').'/wp-admin/themes.php?dummy_insert=1">Yes, insert sample data please</a></p>');
			}
